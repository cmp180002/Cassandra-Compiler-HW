//
// Symbol Table Module
// - this code is psuedo-object-oriented in that each function
//   takes a pointer to a table as its first argument; thus it
//   acts as a method on that table "object"; the "newSymbolTable"
//   function acts like a constructor, creating a new table
              ...
              unsigned int size, int offset, SymbolKind kind)
{
   ...
   if (findSymbol(table, name) != NULL) return -1;
...
//   the linked list at that index to see if the name exists as a symbol
